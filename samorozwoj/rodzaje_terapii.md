...
Skupia się na zmianie nieadaptacyjnych myśli, przekonań i zachowań. Pomaga rozpoznawać i modyfikować negatywne schematy myślenia oraz uczy nowych, bardziej konstruktywnych sposobów radzenia sobie z trudnościami.
### Metody
Praca z myślami automatycznymi, ekspozycja na bodźce lękowe, trening umiejętności społecznych, zadania domowe, techniki relaksacyjne.
### Polecane dla
Zaburzeń lękowych, depresji, fobii, zaburzeń obsesyjno-kompulsyjnych, zaburzeń odżywiania, problemów z kontrolą impulsów, bezsenności.
## Psychoterapia psychodynamiczna
### Nad czym się pracuje
Analiza nieświadomych konfliktów, które mają źródło w przeszłości (często w dzieciństwie) i wpływają na obecne funkcjonowanie. Celem jest uświadomienie sobie mechanizmów obronnych i wzorców relacji.
### Metody
Swobodna rozmowa, analiza snów, interpretacja przeżyć, praca nad relacją terapeutyczną.
### Polecane dla
Zaburzeń osobowości, przewlekłych zaburzeń depresyjnych, trudności w relacjach, problemów emocjonalnych, niskiej samooceny.
## Psychoterapia humanistyczna (np. Gestalt)
### Nad czym się pracuje
Rozwój samoświadomości, poczucia własnej wartości, autentyczności i odpowiedzialności za własne życie. Skupia się na „tu i teraz” oraz pełnym przeżywaniu emocji.
### Metody
Praca z emocjami, ćwiczenia zwiększające świadomość ciała i uczuć, dialog egzystencjalny, techniki kreatywne.
### Polecane dla
Osób poszukujących rozwoju osobistego, mających trudności w relacjach, przeżywających kryzysy egzystencjalne, niską samoocenę, trudności w wyrażaniu emocji.
## Psychoterapia systemowa
### Nad czym się pracuje:
Analiza relacji i wzorców komunikacji w rodzinie lub grupie. Problemy jednostki są postrzegane jako wynik funkcjonowania całego systemu rodzinnego.
### Metody
Sesje rodzinne lub grupowe, praca nad komunikacją i rozwiązywaniem konfliktów, analiza ról w systemie.
### Polecane dla
Problemów rodzinnych, konfliktów małżeńskich, trudności wychowawczych, zaburzeń dzieci i młodzieży, uzależnień.
## Psychoterapia integracyjna
Nad czym się pracuje:
Łączy elementy różnych podejść, dopasowując metody do indywidualnych potrzeb pacjenta.
### Metody
